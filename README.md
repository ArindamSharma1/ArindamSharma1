...
#### 🛠️ Tech Stack
- **Core:** React, Node.js, TypeScript, Next.js  
...
| :--- | :--- | :--- |
| **[FolioGauge](https://github.com/ArindamSharma1/FolioGauge)** | *Next.js, TypeScript, Python* | SaaS platform that analyzes developer portfolios and provides structured feedback on UX, content, and performance. |
